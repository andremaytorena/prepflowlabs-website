...
const AnimatedBackground: React.FC = () => {
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute inset-0" style={{ backgroundColor: 'rgba(225, 235, 245, 0.8)' }} />
            ...
            <div className="absolute inset-0" style={{ zIndex: 3, overflow: 'hidden' }}>
                <div style={{
                    ...
                    top: 0,
                    left: 0,
                    background: 'radial-gradient(ellipse at top left, rgba(255, 255, 255, 0.4) 0%, rgba(255, 255, 255, 0.25) 25%, rgba(255, 255, 255, 0.15) 50%, transparent 70%)',
                    mixBlendMode: 'normal',
                    opacity: 1,
                    animation: 'rayGlow1 20s ease-in-out infinite alternate',
                }}>
                    ...
                    <div style={{
                        ...
                        top: '-20vh',
                        left: '2%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.35) 40%, rgba(255, 255, 255, 0.1) 70%, transparent 100%)',
                    ...
                    <div style={{
                        ...
                        top: '-15vh',
                        left: '15%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.6) 0%, rgba(255, 255, 255, 0.28) 45%, rgba(255, 255, 255, 0.08) 75%, transparent 100%)',
                        transform: 'skewX(50deg) rotate(-12deg)',
                        filter: 'blur(0.2px) drop-shadow(0 0 18px rgba(255, 255, 255, 0.35))',
                        mixBlendMode: 'normal',
                        opacity: 0.85,
                        animation: 'rayFloat2 30s ease-in-out infinite reverse',
                    }} />
                    ...
                    <div style={{
                        ...
                        top: '-25vh',
                        left: '35%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.65) 0%, rgba(255, 255, 255, 0.32) 35%, rgba(255, 255, 255, 0.1) 70%, transparent 100%)',
                    ...
                    <div style={{
                        ...
                        top: '-10vh',
                        left: '55%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.55) 0%, rgba(255, 255, 255, 0.25) 50%, rgba(255, 255, 255, 0.08) 80%, transparent 100%)',
                        transform: 'skewX(52deg) rotate(-8deg)',
                        filter: 'blur(0.4px) drop-shadow(0 0 16px rgba(255, 255, 255, 0.3))',
                        mixBlendMode: 'normal',
                        opacity: 0.8,
                        animation: 'rayFloat4 40s ease-in-out infinite reverse',
                    }} />
                    ...
                    <div style={{
                        ...
                        top: '-30vh',
                        left: '75%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.6) 0%, rgba(255, 255, 255, 0.28) 42%, rgba(255, 255, 255, 0.08) 75%, transparent 100%)',
                    ...
                    <div style={{
                        ...
                        top: '-18vh',
                        left: '-5%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.35) 0%, rgba(255, 255, 255, 0.12) 45%, rgba(255, 255, 255, 0.02) 80%, transparent 100%)',
                        transform: 'skewX(44deg) rotate(-10deg)',
                        filter: 'blur(0.4px) drop-shadow(0 0 17px rgba(255, 255, 255, 0.32))',
                        mixBlendMode: 'normal',
                        opacity: 0.8,
                        animation: 'rayFloat6 32s ease-in-out infinite reverse',
                    }} />
                    ...
                    <div style={{
                        ...
                        top: '-22vh',
                        left: '8%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.3) 0%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.02) 85%, transparent 100%)',
                    ...
                    <div style={{
                        ...
                        top: '-12vh',
                        left: '25%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.38) 0%, rgba(255, 255, 255, 0.14) 40%, rgba(255, 255, 255, 0.03) 75%, transparent 100%)',
                        transform: 'skewX(47deg) rotate(-13deg)',
                        filter: 'blur(0.6px) drop-shadow(0 0 21px rgba(255, 255, 255, 0.4))',
                        mixBlendMode: 'normal',
                        opacity: 0.7,
                        animation: 'rayFloat8 26s ease-in-out infinite reverse',
                    }} />
                    ...
                    <div style={{
                        ...
                        top: '-28vh',
                        left: '45%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.33) 0%, rgba(255, 255, 255, 0.11) 48%, rgba(255, 255, 255, 0.02) 82%, transparent 100%)',
                    ...
                    <div style={{
                        ...
                        top: '-16vh',
                        left: '65%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.36) 0%, rgba(255, 255, 255, 0.13) 44%, rgba(255, 255, 255, 0.02) 78%, transparent 100%)',
                        transform: 'skewX(43deg) rotate(-16deg)',
                        filter: 'blur(0.4px) drop-shadow(0 0 19px rgba(255, 255, 255, 0.36))',
                        mixBlendMode: 'normal',
                        opacity: 0.8,
                        animation: 'rayFloat10 30s ease-in-out infinite reverse',
                    }} />
                    ...
                    <div style={{
                        ...
                        top: '-24vh',
                        left: '85%',
                        background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.32) 0%, rgba(255, 255, 255, 0.1) 46%, rgba(255, 255, 255, 0.02) 84%, transparent 100%)',
            ...
            <style jsx>{`
                ...
                @keyframes cloudFloat1 {
                    ...
                    50% { 
                        transform: translateX(calc(50vw)) translateY(-20px) scale(1.1);
                    }
                    100% { 
                ...
                @keyframes cloudFloat2 {
                    ...
                    50% { 
                        transform: translateX(calc(-50vw)) translateY(15px) scale(1.05);
                    }
                    100% { 
                        transform: translateX(calc(-100vw - 100px)) translateY(0px) scale(0.9);
                    }
                }
                ...
                @keyframes cloudFloat3 {
                    ...
                    33% { 
                        transform: translateX(-200px) translateY(-10px) scale(0.9);
                    }
                    66% { 
                ...
                @keyframes cloudFloat4 {
                    ...
                    75% { 
                        transform: translateX(-450px) translateY(10px) scale(1.2);
                    }
                    100% { 
                ...
                @keyframes cloudFloat5 {
                    ...
                    40% { 
                        transform: translateX(calc(40vw)) translateY(-15px) scale(0.9);
                    }
                    80% { 
                        transform: translateX(calc(80vw)) translateY(8px) scale(1.1);
                    }
                    100% { 
