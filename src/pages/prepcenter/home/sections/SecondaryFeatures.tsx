...
import screenshotInventory from "../../../../assets/prepcenter/inventory.png";
import screenshotInvoices from "../../../../assets/prepcenter/invoices.png";
import screenshotTrackings from "../../../../assets/prepcenter/trackings.png";
...
const features: Array<Feature> = [
    {
        name: "Invoices",
        summary: "Stay on top of your invoices with a ongoing invoice system.",
        description:
            "Stop manually charging your clients and connect your desired payment gateway such as Stripe.",
    ...
    },
    {
        ...
        description:
            "Automatically bill inventory charges to clients with your desired grace period and charge amount.",
    ...
    {
        name: "Trackings",
        summary: "Organize all of your tracking numbers in one place.",
        description:
            "Our software connects to popular tracking number API's such as UPS, USPS and more to retrieve the status of the shipment.",
        image: screenshotTrackings,
        ...
        >
            <div
                className={clsx(
                    "w-9 rounded-lg",
                    isActive
                        ? "bg-gradient-to-r from-[#C33764] via-[#302b63] to-[#1D2671]"
                        : "bg-slate-500"
                )}
            >
            ...
            <h3
                className={clsx(
                    ...
                    isActive
                        ? "bg-gradient-to-r from-[#C33764] via-[#302b63] to-[#1D2671] bg-clip-text text-transparent"
                        : "text-slate-600"
                )}
            >
                {feature.name}
